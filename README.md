...
1. [Create a new Extend Override App on Admin Portal](https://docs.accelbyte.io/gaming-services/services/extend/override/getting-started-with-entitlement-revocation-customization/#create-the-extend-app). Keep the `Repository URI`.
